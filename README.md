...
├── conf/                           // Configurations about workers and executors
...
debug -A Aurora_deployment -l select=2 -l walltime=2:00:00 -l filesystems=flare:daos_user -q lustre_scaling -v SPARKJOB_SCRIPTS_DIR=$HOME/spark-job/bin,SPARKJOB_CONFIG_DIR=$HOME/spark-job/conf,SPARKJOB_INTERACTIVE=0,SPARKJOB_SCRIPTMODE=0,SPARKJOB_OUTPUT_DIR=$HOME/spark-job/conf,SPARKJOB_SEPARATE_MASTER=0,SPARKJOB_OAPML=1,SPARKJOB_DAOS=1,SPARKJOB_ARG=$HOME/spark-job/example/kmeans-pyspark.py^daos://Intel2/hadoop_fs/HiBench/Kmeans/Input/36000000 -o $HOME/spark-job/conf -e $HOME/spark-job/conf $HOME/spark-job/bin/start-spark.sh
# Submitted
...
debug -A Aurora_deployment -l select=2 -l walltime=2:00:00 -l filesystems=flare:daos_user -q lustre_scaling -v SPARKJOB_SCRIPTS_DIR=$HOME/spark-job/bin,SPARKJOB_CONFIG_DIR=$HOME/spark-job/conf,SPARKJOB_INTERACTIVE=1,SPARKJOB_SCRIPTMODE=0,SPARKJOB_OUTPUT_DIR=$HOME/spark-job/conf,SPARKJOB_SEPARATE_MASTER=0,SPARKJOB_OAPML=1,SPARKJOB_DAOS=1,SPARKJOB_ARG= -o $HOME/spark-job/conf -e $HOME/spark-job/conf $HOME/spark-job/bin/start-spark.sh
# Submitted
SPARKJOB_JOBID=67690.amn-0001
need spark job host: 0
Waiting for Spark to launch by checking $HOME/spark-job/conf/67690.amn-0001
