...
class Timer():
    def __init__(self, algoName):
        ...
        self._filename = algoName + "_1time_breakdown"
        redirect_path = os.environ.get('SPARKJOB_CONFIG_DIR')
        current_directory = redirect_path + "/" + self._filename
        self._filename = current_directory
